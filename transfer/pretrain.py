...
from transfer.chem_splitters import scaffold_split, random_split, random_scaffold_split
from transfer.chem_model import GNN_CL
from transfer.chem_loader import MoleculeDataset_aug
...
if __name__ == "__main__":
    ...
    view_gen1 = ViewGenerator(dataset, 128, 128, GIN_NodeWeightEncoder, mlp_edge_encoder)
    view_gen2 = ViewGenerator(dataset, 128, 128, GIN_NodeWeightEncoder, mlp_edge_encoder)
