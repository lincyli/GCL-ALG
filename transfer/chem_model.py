...
class GINConv(MessagePassing):
    ...
    def forward(self, x, edge_index, edge_attr):
        ...
        self_loop_attr = self_loop_attr.to(edge_attr.device) #tself_loop_attr:torch.Size([6519, 2])
...
class GNN_CL(torch.nn.Module):
    ...
    def forward(self,sample,*argv):
        ...
        if sample is not None:
            x = x * sample.view(-1, 1) #sample:torch.Size([2827]) x:torch.Size([6527, 300])
